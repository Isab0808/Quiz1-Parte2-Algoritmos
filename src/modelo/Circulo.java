...
public final static int SPEED = 3;
	...
	private boolean estadoCirculo;
	
	public Circulo(int posicionX, int posicionY, int tamaño, PApplet app) {
	...
	public void pintar (PApplet app) {
		app.fill(r,g,b);
		app.ellipse(posicionX, posicionY, tamaño, tamaño);
		app.textSize(15);
		app.fill(0);
	...
	public void setmover(boolean estadoCuadrado) {
		this.estadoCirculo = estadoCuadrado;
		
	}
	public boolean estadoCuadrado() {
		return estadoCirculo;
	}
